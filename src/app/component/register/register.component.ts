...
import { registerconfirm, userregister } from '../../model/user.model';
      ...
      if(this._regform.valid){
        ...
        this.service.Userregistration(_obj).subscribe(item=>{
              ...
              if(this._response.result=='pass')
              {
                ...
                this.toastr.success('Validate OTP & complete the registration : ',  'Registeration');
                this.router.navigateByUrl('/confirmotp')
              }
              else
              {
                this.toastr.error('Failed due to the : ' + this._response.message, 'Registration Failed');
              }
        });
      }
    }
